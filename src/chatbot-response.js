...
function getChatbotResponse(webhook_event, sender_psid) {
    ...
    return type === 'thank-you' && getReplyAndEmail(webhook_event, 'thank-you', sender_psid, _.get(webhook_event, 'message.text'))
      ...
      || type === 'muay-thai-info' && getReplyWithUser(webhook_event, 'muay-thai-info')
      || type === 'end-conversation' && getReply(webhook_event, 'end-conversation')
      || type === 'sticker' && getReply(webhook_event, 'end-conversation')
      || type === 'schedule' && getReplyWithUser(webhook_event, 'schedule-combined')
      || type === 'schedule-price' && getReplyWithUser(webhook_event, 'schedule-price-combined')
